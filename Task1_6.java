...
public class Task1_6 {
    ...
    public static void main(String[] args) {
        ...
        // ③ 名前のみ正しい場合、「 パスワードに誤りがあります。 」と出力してください。
        	...
        	System.out.println(CONST_MSG_EROOR_PASS);
        }
